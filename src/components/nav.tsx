...
export default function Nav({
  ...
  return (
    <div className="flex lg:flex-row-reverse">
      ...
      <div className="fixed bottom-0 z-20 flex w-[100%] justify-around p-6 text-sm font-medium leading-4 tracking-tight text-muted-foreground decoration-2 underline-offset-2 lg:relative lg:bottom-auto lg:flex lg:w-auto lg:flex-col lg:justify-normal lg:space-y-8 lg:p-6 lg:text-lg lg:leading-4">
        <Link
