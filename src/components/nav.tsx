...
export default function Nav({
  ...
  return (
    <div className="flex h-screen flex-col md:flex-row-reverse">
      ...
      <div className="flex justify-around border-t-[1px] p-3 font-medium leading-4 tracking-tight text-muted-foreground decoration-2 underline-offset-2 md:flex-col md:justify-normal md:space-y-6 md:p-4">
        <Link
